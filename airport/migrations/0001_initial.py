    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(null=True, upload_to=airport.models.airline_image_file_path)),
            ],
        ),
        migrations.CreateModel(
            name='Airplane',
            fields=[
                ...
                ('airline', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='airport.airline')),
            ],
        ),
        migrations.CreateModel(
            name='AirplaneType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('economy', 'Economy'), ('business', 'Business'), ('first_class', 'First Class'), ('premium_economy', 'Premium Economy')], max_length=20, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='airport.ticketclass')),
            ],
            options={
                'ordering': ['row', 'seat'],
